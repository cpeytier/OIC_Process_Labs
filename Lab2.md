...
The steps you need to do in this lab are::
...
**Putting in place the initial application**
...
3.  Open the Travel Application that you have created in the previous lab.
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/37abc67ee889fdba9384179118959b58.png](media/37abc67ee889fdba9384179118959b58.png)
...
1.  From *Process,* click *Decision Models*

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/afd8e7efa87a3ca09b371f7ad0b3b135.png](media/afd8e7efa87a3ca09b371f7ad0b3b135.png)

1.  Under the **Create** button, chose *Import a Decision Model*

2.  Give it the name that is preceded with your Student number to avoid
    confusion with other people’s work (in case you are on a shared environment)

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/d381672dd49a14afe068266c579694ce.png](media/d381672dd49a14afe068266c579694ce.png)

Click the **Import** button

**Step 3: Study the Expression**

The "days before Travel" expression allows us to calculate the number of days
between 2 dates

1.  Click the white on blue “V” sign on th right of the Expression and ook at
    *DaysbeforeTravel*
...
1.  Click the white on blue “V” sign to expand the Decision Table
...
1.  You can study the four input fields that will be required in order for the
    rule to be evaluated

2.  Look at how the **Output Decisions** field was added as the field that will
    be returned by this rule

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/de4727b0a1ca8827ef010fcc0c7a7f23.png](media/de4727b0a1ca8827ef010fcc0c7a7f23.png)

1.  At the end, the service definition looks like this:

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/3880256290c524cf7b9af6f8c5004461.png](media/3880256290c524cf7b9af6f8c5004461.png)
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/ff87096fa968c6dff583d23bb7e7fd40.png](media/ff87096fa968c6dff583d23bb7e7fd40.png)

1.  Click the **Start Test** button. You should see the result of the decision
    evaluation appearing, set to **True**.

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/4fe710bdfa362fd41b2c35380b7e2902.png](media/4fe710bdfa362fd41b2c35380b7e2902.png)

1.  Put an amount of 1200€, and change the date interval to be less than 15
    days, and then test again. Your decision should now evaluate to **False**
    despite the fact that the country is France.

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/0ab0e5668278d31019916eb9b0402238.png](media/0ab0e5668278d31019916eb9b0402238.png)
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/d315124e5fec72de584b867847190e8a.png](media/d315124e5fec72de584b867847190e8a.png)
...
The Entry form of the generated travel application does not have a field named
"country of Destination". We will need this in order to be able to test our
rule.
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/37f934e178cf79104941bdbd5185b91c.png](media/37f934e178cf79104941bdbd5185b91c.png)

1.  Rename the field *countryOfDestination*, and the label "Country of
    Destination".

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/1218ca595594ba835bd30a9c7b467d05.png](media/1218ca595594ba835bd30a9c7b467d05.png)
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/52018ab5b3c64e64f56f0c27414dab8e.png](media/52018ab5b3c64e64f56f0c27414dab8e.png)

1.  Click on the **Travel Approval** process

2.  Add the deployed Decision Model

    1.  From the right pane, drag-and-drop a Decision task onto the canvas at
        this position:

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/f64be1c185029ee26daf0845db596919.png](media/f64be1c185029ee26daf0845db596919.png)

1.  Change the title of Decision model to *AutoApprove Decision*.

2.  Add a Gateway to fork between auto approve and management approval
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/2a18ebe45ed6786cde123823d0fc3765.png](media/2a18ebe45ed6786cde123823d0fc3765.png)

1.  Implement the Decision Model
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/771addb7bd474f13d6ce1daf245dd4ac.png](media/771addb7bd474f13d6ce1daf245dd4ac.png)

1.  Modify the Data Association

    1.  Highlight the Decision task, and open the **Data Association**.

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/c301a62d6e1c7f20207b6487e452ab6b.png](media/c301a62d6e1c7f20207b6487e452ab6b.png)

1.  Map the fields from the **newWebForm** with the four required field of the
    AutoApproved Decision.

2.  **NOTE**: Map **CurrentDate** to the value *‘now’* (with single quotes).

3.  Your mapping should look like this:

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/6207508fe7c9947e25a8029cc6313afa.png](media/6207508fe7c9947e25a8029cc6313afa.png)

1.  Map the Output field Data Association

    1.  Click the **Output** tab on the top left, and add a new Data object by
        clicking the blue “**+**” on the right.

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/860f1432b90c08dc4efbe30e2ef56d42.png](media/860f1432b90c08dc4efbe30e2ef56d42.png)

1.  Add a new **Data object** of type *Boolean*, name it
    *autoApprovedDataObject*. (NOTE: the name has to start with a lowercase
    letter).

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/e560a653e7618af67691f8d4b9a0929c.png](media/e560a653e7618af67691f8d4b9a0929c.png)

1.  Map the output of the Decision Model task (the **Interpretation** field) to
    this newly created DataObject:

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/590fa90b88c1dcfaec2b11f926be63eb.png](media/590fa90b88c1dcfaec2b11f926be63eb.png)

1.  Click the **Apply** button.

2.  Add the Gateway condition:

    1.  Select the gateway branch that goes to Book travel, and edit it.

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/916d52a91a1605a48812d765be64d5a4.png](media/916d52a91a1605a48812d765be64d5a4.png)

1.  Edit the condition for the gateway by clicking the pencil on the right.

2.  Highlight the **autoApprovedDataObject** and click **Insert into
    Expression**

![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/add60425c63fc3181e17d3316dd8061b.png](media/add60425c63fc3181e17d3316dd8061b.png)

1.  Add **== “true”** then click the **OK** button at the bottom.
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/321a901689ca6921d47d9ffe9bff7a7f.png](media/321a901689ca6921d47d9ffe9bff7a7f.png)
...
1.  Do a second test by entering the same values on your form, except the dates
...
**BONUS Step: Changing the decision criteria.**

We are now going to relax a bit the Travel criteria. Instead of a threshold of
...
![https://github.com/cpeytier/OIC_Process_labs/raw/master/media/bde7bd9def32b9f152f79682f946102a.png](media/bde7bd9def32b9f152f79682f946102a.png)

1.  Return to OIC Home and run again your application
...
1.  Check again your Task list. This time, you should NOT have a task waiting,
